      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <div className="absolute inset-0 pointer-events-none transition-opacity duration-700 opacity-100 dark:opacity-0 backdrop-blur-md [mask-image:radial-gradient(circle_at_50%_50%,transparent_45%,black_100%)] [-webkit-mask-image:radial-gradient(circle_at_50%_50%,transparent_45%,black_100%)]" />
