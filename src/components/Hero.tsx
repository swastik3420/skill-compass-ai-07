          ...
          >
            ...
            <img
              ...
              className="absolute inset-0 w-full h-full object-contain select-none pointer-events-none transition-all duration-700
                ...
                [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,black_45%,transparent_75%)]
                [-webkit-mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,black_45%,transparent_75%)]
            ...
            {/* Edge fade into page background (wider ellipse to show both brain sides in day mode) */}
            <div className="absolute inset-0 pointer-events-none transition-opacity duration-700 opacity-100 dark:opacity-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_50%,transparent_45%,hsl(var(--background))_70%)]" />
