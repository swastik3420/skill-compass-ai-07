          ...
          >
            ...
            <img
              ...
              className="absolute inset-0 w-full h-full object-contain select-none pointer-events-none transition-all duration-700
                ...
                [mask-image:radial-gradient(circle_at_50%_50%,black_25%,transparent_70%)]
                [-webkit-mask-image:radial-gradient(circle_at_50%_50%,black_25%,transparent_70%)]
            ...
            {/* Edge fade into page background (smoother circular shape in day mode) */}
            <div className="absolute inset-0 pointer-events-none transition-opacity duration-700 opacity-100 dark:opacity-0 bg-[radial-gradient(circle_at_50%_50%,transparent_25%,hsl(var(--background))_55%)]" />
