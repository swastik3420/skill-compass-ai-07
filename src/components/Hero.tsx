          ...
          >
            ...
            <img
              ...
              className="absolute inset-0 w-full h-full object-contain select-none pointer-events-none transition-all duration-700
                ...
                [mask-image:radial-gradient(ellipse_53%_50%_at_50%_50%,black_45%,transparent_75%)]
                [-webkit-mask-image:radial-gradient(ellipse_53%_50%_at_50%_50%,black_45%,transparent_75%)]
            ...
            <div className="absolute inset-0 pointer-events-none transition-opacity duration-700 opacity-100 dark:opacity-0 bg-[radial-gradient(ellipse_53%_50%_at_50%_50%,transparent_45%,hsl(var(--background))_72%)]" />
