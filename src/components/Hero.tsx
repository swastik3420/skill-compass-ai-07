          ...
          >
            ...
            <img
              ...
              className="absolute inset-0 w-full h-full object-contain select-none pointer-events-none transition-all duration-700
                ...
                [mask-image:radial-gradient(circle_at_50%_50%,black_45%,black_55%,transparent_70%)]
                [-webkit-mask-image:radial-gradient(circle_at_50%_50%,black_45%,black_55%,transparent_70%)]
            ...
            <div className="absolute inset-0 pointer-events-none transition-opacity duration-700 opacity-100 dark:opacity-0 bg-[radial-gradient(circle_at_50%_50%,transparent_52%,hsl(var(--background))_65%)]" />
