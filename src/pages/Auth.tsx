...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative">
      <Link
        to="/"
        className="absolute top-4 left-4 inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors px-3 py-2 rounded-lg hover:bg-muted"
      >
      ...
      >
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2 mb-6">
            <div className="w-10 h-10 gradient-primary rounded-none flex items-center justify-center">
          ...
          <p className="text-muted-foreground">
            {isLogin 
              ? "Sign in to access your career progress" 
              : "Start tracking your career development"
            }
          </p>
        </div>
